function []=Tool_ComputeFeat(CmdFile)
...
% Input:
%      CmdFile: given by user, (use default 'Tool_ComputeFeat.dcf', if not specified)
%Output:
...
defCmdFile = 'Tool_ComputeFeat.dcf'; % This is the default setup file for this program.
